...
def main():
    ...
    queries_jsonl_out = outputs_dir / f"queries_embeddings_{ts}.jsonl"
    ...
    queries_jsonl_fp = open(queries_jsonl_out, "w", encoding="utf-8")
